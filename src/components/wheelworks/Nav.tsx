    ...
    >
      <div className="glass rounded-full px-5 py-2.5 flex items-center justify-between">
        <a href="#top" className="flex items-center gap-2.5">
          <div className="h-8 w-8 rounded-full bg-white text-black grid place-items-center text-[10px] font-bold tracking-tighter">WW</div>
          <span className="text-sm font-semibold tracking-tight">Wheelworks <span className="text-white/50">VIP</span></span>
        </a>
        ...
        >
          ...
          <span className="hidden sm:inline">215-947-8927</span>
