    ...
    <footer className="relative border-t border-white/10 px-6 py-12">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-6 text-sm">
        <div className="flex items-center gap-2.5">
          <div className="h-7 w-7 rounded-full bg-white text-black grid place-items-center text-[10px] font-bold">MD</div>
          <span className="text-white font-semibold">Mansory <span className="text-white/50">Detailing</span></span>
        </div>
        <div className="text-white/50 text-xs">
          1940 Pioneer Rd, Huntingdon Valley, PA 19006
        </div>
        <a
          href="tel:2153988619"
      ...
      <div className="max-w-6xl mx-auto mt-8 text-[11px] text-white/35">
        © {new Date().getFullYear()} Mansory Detailing. All rights reserved.
      </div>
    </footer>
  );
}